...
export default function Admin() {
  ...
  return (
    <>
      <h1 style={{textAlign:'center', padding:'40px', fontFamily:'Times new Roman'}}>Clientes</h1>
      
      <button className="btn btn-danger" style={{ marginLeft: '103rem' }} type="button" >
      ...
      {clientes.map((cliente) => (
        <div key={cliente.id} className="card container" style={{ marginBottom: '0.8rem', backgroundColor: '#CBEED6' }}>
